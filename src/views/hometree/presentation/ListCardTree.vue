        ...
        <div class="row justify-content-center text-center my-sm-5">
          <div class="col-lg-6">
            <MaterialBadge color="success" class="mb-3"
              >Giới thiệu</MaterialBadge
            >

            <h2 class="text-dark mb-0">Bộ sư tập một số loại cây trồng</h2>
            <p class="lead">
              Chúng mình đã tạo khá nhiều các tùy chọn, bạn có thể tham khảo một số giống loài 
              gần gũi dễ trồng và lưu trữ chúng ở đây nhé!.
            </p>
          </div>
        </div>
      </div>
