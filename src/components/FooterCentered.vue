...
defineProps({
  ...
  links: {
    ...
    href: String,
    default: () => [
      { href: "https://www.ctu.edu.vn/", name: "Công ty" },
      { href: "https://www.creative-tim.com/presentation", name: "Về chúng tôi" },
      { href: "https://www.creative-tim.com/presentation", name: "Nhóm" },
      {
        href: "",
        name: "Cây trồng",
      },
      ...
      <div class="row">
        <div class="col-8 mx-auto text-center mt-1">
          <p class="mb-0 text-secondary">
            Copyright © {{ new Date().getFullYear() }} Website by tramb1910007 University CTU.
          </p>
        </div>
      </div>
    </div>
